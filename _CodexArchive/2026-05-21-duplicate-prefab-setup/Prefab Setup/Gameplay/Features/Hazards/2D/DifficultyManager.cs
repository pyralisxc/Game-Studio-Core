...
{
    // â”€â”€ Shared structs / enums â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Wave entry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Inspector fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    [SerializeField, Tooltip("Seconds the warning outline flashes before the slam. Usually kept short (0.3â€“0.6s).")]
    ...
    [SerializeField, Tooltip("Exponential mode only â€” controls curve steepness. Higher = gentler early ramp.")]
    [Range(0.5f, 5f)]
    ...
    [Header("Step Mode")]
    [SerializeField, Tooltip("Step mode only â€” seconds between each difficulty step-up.")]
    private float _stepInterval = 30f;
    [SerializeField, Tooltip("Step mode only â€” how much spawn interval shrinks per step.")]
    private float _spawnIntervalStepAmount = 0.3f;
    [SerializeField, Tooltip("Step mode only â€” how much shadow duration shrinks per step.")]
    private float _shadowDurationStepAmount = 0.2f;
    [SerializeField, Tooltip("Step mode only â€” how much the minimum hazard count increases per step.")]
    private int _minHazardsStepAmount = 0;
    [SerializeField, Tooltip("Step mode only â€” how much the maximum hazard count increases per step.")]
    private int _maxHazardsStepAmount = 1;
    [SerializeField, Tooltip("Step mode only â€” how much the minimum spawn count per burst increases per step. 0 = never grows.")]
    private int _minSpawnCountStepAmount = 0;
    [SerializeField, Tooltip("Step mode only â€” how much the maximum spawn count per burst increases per step. 0 = never grows. Set to 1 to add one extra hazard per burst each step.")]
    private int _maxSpawnCountStepAmount = 1;

    [Header("Wave Mode â€” Waves")]
    ...
    // NonSerialized â€” these are live display values only. Marking them [SerializeField]
    ...
    // â”€â”€ Public events â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Runtime state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Public properties â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    private int PickNextWaveIndex()
    {
        ...
        // Sequential is inherently non-repeating â€” just advance.
