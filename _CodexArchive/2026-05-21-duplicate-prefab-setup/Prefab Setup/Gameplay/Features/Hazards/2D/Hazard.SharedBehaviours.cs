...
public partial class Hazard
{
    ...
    private static void SpawnCollectiblesAt(Vector2 position, int count, float radius)
    {
        CollectibleSpawner2D.Instance?.SpawnCollectiblesAt(position, count, radius);
    }
