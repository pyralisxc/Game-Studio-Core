...
public partial class Hazard
{
    ...
    private Vector2 PickInitialBouncyDirection(HazardData.BouncePatternType pattern)
    {
        switch (pattern)
        {
            ...
            case HazardData.BouncePatternType.Diagonal:
                // One of the 4 cardinal 45� diagonals.
            ...
            case HazardData.BouncePatternType.Orbit:
                ...
                if (Player != null && Player.gameObject.activeInHierarchy)
                {
                    ...
                    // Perpendicular: rotate 90� (CW or CCW based on _orbitClockwise chosen at TravelBouncy start)
    ...
    private Vector2 PickNextBouncyDirection(HazardData.BouncePatternType pattern, Vector2 currentDir)
    {
        switch (pattern)
        {
            ...
            case HazardData.BouncePatternType.Diagonal:
                // Billiard-style: randomly flip one axis to change to another 45� diagonal.
            ...
            case HazardData.BouncePatternType.Ricochet:
                // Deflects ~90� left or right of the current direction � clean wall-ricochet feel.
                // Random variation of �20� around perpendicular keeps it slightly unpredictable.
            ...
            case HazardData.BouncePatternType.Zigzag:
                // Alternates a hard left (120�) or right (-120�) turn each bounce.
            ...
            case HazardData.BouncePatternType.Orbit:
                // Consistent 90� clockwise or counterclockwise turn � circles the arena.
