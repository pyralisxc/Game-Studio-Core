...
///      This is the Activation Zone â€” set its Image alpha to 0 (invisible but raycast-able).
...
public class VirtualJoystick : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("RectTransform of the joystick background circle (child of this GameObject).\n" +
        "Set Anchor and Pivot to centre (0.5, 0.5). Raycast Target can be OFF â€” input is handled by raw touch.")]
...
#if UNITY_EDITOR
        // Mouse fallback â€” lets you test the joystick in the Editor without a touch device.
        UpdateMouse();
#endif
    }
        ...
        foreach (var touch in touchscreen.touches)
        {
            ...
            if (id == _activeTouchId)
            {
                    ...
                    phase == UnityEngine.InputSystem.TouchPhase.Canceled)
                {
                    ...
                    // still processed â€” a new Began touch placed in the same frame that
    ...
    private void SpawnAt(Vector2 screenPos)
    {
        ...
        _canvasGroup.blocksRaycasts = false; // never block touches â€” raw input handles everything
