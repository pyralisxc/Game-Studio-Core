...
namespace NeonBlack.Gameplay.Characters
{
    ...
    public static class ParticipantQueryUtility
    {
        ...
        {
            roster = null;
            return GameplayPlatformContext.Current != null
                && GameplayPlatformContext.Current.Services.TryResolve(out roster)
                && roster != null;
        }
        ...
        public static bool TryResolvePlayerProvider(out IPlayerProvider playerProvider)
        {
            playerProvider = null;
            return GameplayPlatformContext.Current != null
                && GameplayPlatformContext.Current.Services.TryResolve(out playerProvider)
                && playerProvider != null;
        }
