...
Assign the selected patterns to a `GameSetupProfile`, then assign that setup profile to `GameModeDefinition.setupProfile`.
...
| Chess, checkers, or board game | Board/Card/Tabletop, Turn/Menu Action, Camera/Cursor Control, Scoring/Objectives | No |
