...
namespace NeonBlack.Gameplay.Core.Navigation
{
    ...
    /// Create via: Assets -> Create -> NeonBlack -> Gameplay -> Scene Flow -> Level Data
    ///
    /// Setup:
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "NeonBlack/Gameplay/Scene Flow/Level Data", fileName = "LevelData_New")]
