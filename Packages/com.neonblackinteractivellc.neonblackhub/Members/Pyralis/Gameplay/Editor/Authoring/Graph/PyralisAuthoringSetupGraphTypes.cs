    ...
    public sealed class PyralisAuthoringGraphNode
    {
        ...
        private static PyralisAuthoringGraphSourceOrigin InferSourceOrigin(PyralisAuthoringGraphSourceKind sourceKind)
        {
            return sourceKind switch
            {
                ...
                PyralisAuthoringGraphSourceKind.CoreSetup => PyralisAuthoringGraphSourceOrigin.Vocabulary,
                ...
                PyralisAuthoringGraphSourceKind.CapabilityVocabulary => PyralisAuthoringGraphSourceOrigin.Vocabulary,
                PyralisAuthoringGraphSourceKind.VocabularyRegistry => PyralisAuthoringGraphSourceOrigin.Vocabulary,
                PyralisAuthoringGraphSourceKind.ProofVocabulary => PyralisAuthoringGraphSourceOrigin.VocabularyFallback,
