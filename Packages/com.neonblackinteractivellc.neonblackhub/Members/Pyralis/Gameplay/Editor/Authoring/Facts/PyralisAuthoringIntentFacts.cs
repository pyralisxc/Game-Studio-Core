        ...
        public IReadOnlyList<PyralisAuthoringFact> GetAuthoringFacts()
        {
            return new[]
            {
                ...
                new PyralisAuthoringFact(
                    ...
                    PyralisAuthoringFactSourceKind.Convention,
                    PyralisAuthoringConfidence.Explicit,
                    "A Sprite2D route where pawns, cursors, pickups, projectiles, scoring, HUD, or hazards act on a top-down 2D plane without requiring side-view gravity.",
                    "Use this when the project wants free X/Y movement, twin-stick action, arena movement, top-down interaction, pickups, projectiles, scoring, HUD feedback, or a no-gravity 2D proof.",
