    ...
    public static class PyralisReflectiveFactScanner
    {
        ...
        public static PyralisAuthoringFact CreateFactFromContract(ResolvedAuthoringContract contract, Type type = null)
        {
            ...
            return new PyralisAuthoringFact(
                ...
                relatedStableIds: BuildRelatedStableIds(contract.ProofTargetId, contract.SetupNodeId),
        ...
        private static string[] BuildRelatedStableIds(string proofTargetId, string setupNodeId = null)
        {
            List<string> related = new List<string>();
            if (!string.IsNullOrWhiteSpace(proofTargetId))
                related.Add(proofTargetId);
        ...
        private static void AddRelatedContracts(Type type, List<string> related)
        {
            ...
            for (int i = 0; i < contracts.Count; i++)
            {
                ...
                AddRelatedStableId(related, contract.ProofTargetId);
