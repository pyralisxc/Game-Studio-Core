        ...
        public static IReadOnlyList<PyralisAuthoringFact> GetAuthoringFacts()
        {
            return new[]
            {
                ...
                new PyralisAuthoringFact(
                    ...
                    PyralisAuthoringFactSourceKind.Convention,
                    PyralisAuthoringConfidence.Explicit,
                    "A pawn-backed action route where movement and close-range attacks form the selected proof loop.",
                ...
                new PyralisAuthoringFact(
                    ...
                    "Use this when the project begins with command choice, UI state, card/menu interaction, HUD feedback, or a non-scene-object proof.",
