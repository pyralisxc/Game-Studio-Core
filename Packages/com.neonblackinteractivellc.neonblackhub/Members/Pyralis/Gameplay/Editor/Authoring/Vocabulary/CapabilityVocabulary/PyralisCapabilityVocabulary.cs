...
namespace NeonBlack.Gameplay.Editor
{
    ...
    public sealed class PyralisCapabilityVocabularyCard
    {
            ...
            string[] relatedStableIds = null)
        {
            ...
            NativeActions = BuildNativeActions(assignmentFields, customizationMoments, proof);
            Fact = new PyralisAuthoringFact(
                ...
                System.Array.Empty<string>(),
                CanWait,
                BuildNativeActions(null, null, proof),
        ...
        private static PyralisAuthoringNativeAction[] BuildNativeActions(string[] assignmentFields, string[] customizationMoments, string proof)
        {
            ...
            if (!string.IsNullOrWhiteSpace(proof))
            {
                actions.Add(new PyralisAuthoringNativeAction(
                    ...
                    "the active route",
                    proof,
                    "the proof is observed by the author"));
            }
    ...
    public static class PyralisCapabilityVocabulary
    {
        private static readonly PyralisCapabilityVocabularyCard[] Cards =
        {
            new PyralisCapabilityVocabularyCard(
                ...
                "Use this when the proof is a visible 2D player, NPC, or AI actor body moving in the world.",
                ...
                new[]
                {
                    ...
                    "Place the spawn point where the proof should begin."
                },
            ...
            new PyralisCapabilityVocabularyCard(
                ...
                "Use this when the proof is a 3D brawler, arena actor, action RPG body, local co-op pawn, or billboard character moving through lane depth.",
                new[] { "ParticipantDefinition", "PawnDefinition" },
            ...
            new PyralisCapabilityVocabularyCard(
                ...
                "Use this after the source surface exists and the proof needs cause-and-effect combat or projectile feedback.",
