...
namespace NeonBlack.Gameplay.Editor.Inspectors
{
    public static class GameplayStarterPackFactory
    {
        ...
        public static void CreatePawnStarterPack()
        {
            ...
            PawnPresentationProfile rigged3DPresentationProfile = CreatePresentationProfile(profilesFolder, "Rigged3DPresentationProfile", ActorPresentationMode.ThirdPerson3D);
        ...
        private static PawnPresentationProfile CreatePresentationProfile(string folder, string assetName, ActorPresentationMode mode)
        {
            ...
            profile.useSharedCamera = mode != ActorPresentationMode.ThirdPerson3D;
            profile.rigType = mode == ActorPresentationMode.ThirdPerson3D
