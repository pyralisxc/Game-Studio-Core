...
Surfaces may guide, render, focus Unity windows, and explain next steps. They should not create hidden setup truth that validators, facts, and docs cannot see.
