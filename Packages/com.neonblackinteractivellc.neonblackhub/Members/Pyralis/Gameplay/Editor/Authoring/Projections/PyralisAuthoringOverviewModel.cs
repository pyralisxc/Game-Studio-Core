...
namespace NeonBlack.Gameplay.Editor
{
    ...
    public sealed class PyralisAuthoringOverviewModel
    {
        ...
        private PyralisAuthoringOverviewModel(
            ...
            string proofLabel,
            string proofGuidance,
            string proofSetupSurface,
            string proofSuccessCriteria,
            string proofDeferUntilAfter,
            string proofChainSummary,
            ...
            List<PyralisAuthoringOverviewIssue> later)
        {
            ...
            ProofSetupSurface = proofSetupSurface;
            ProofSuccessCriteria = proofSuccessCriteria;
            ProofDeferUntilAfter = proofDeferUntilAfter;
            ProofChainSummary = proofChainSummary;
        ...
        public string ProofLabel { get; }
        public string ProofGuidance { get; }
        public string ProofSetupSurface { get; }
        public string ProofSuccessCriteria { get; }
        public string ProofDeferUntilAfter { get; }
        public string ProofChainSummary { get; }
            ...
            PyralisAuthoringSetupGraph graph)
        {
            ...
            return new PyralisAuthoringOverviewModel(
                ...
                PyralisAuthoringSetupGraphProjection.GetOverviewProofLabel(graph),
                PyralisAuthoringSetupGraphProjection.GetOverviewProofGuidance(graph),
                PyralisAuthoringSetupGraphProjection.GetOverviewProofSetupSurface(graph),
                PyralisAuthoringSetupGraphProjection.GetOverviewProofSuccessCriteria(graph),
                PyralisAuthoringSetupGraphProjection.GetOverviewProofDeferUntilAfter(graph),
                PyralisAuthoringSetupGraphProjection.GetOverviewProofChainSummary(graph),
