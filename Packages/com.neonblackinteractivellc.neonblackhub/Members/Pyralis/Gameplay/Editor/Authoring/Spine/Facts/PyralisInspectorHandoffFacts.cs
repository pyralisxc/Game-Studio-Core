    ...
    public static class PyralisInspectorHandoffFacts
    {
        public static IReadOnlyList<PyralisAuthoringFact> GetAuthoringFacts()
        {
            return new[]
            {
                ...
                CreateAssignmentFact(
                    "inspector.game-mode-definition.feature-modules",
                    "GameModeDefinition Feature Modules",
                    "Assign feature modules when a route needs reusable systems beyond the core session and participant setup.",
                    "Capability setup",
                    "GameModeDefinition.requiredFeatureModules -> FeatureModuleDefinition[]",
                    "GameModeDefinition",
                    "Required Feature Modules",
                    "the graph can reflect feature-owned contracts and capability requirements",
                    new[] { "setup.resolve-route-capabilities" }),

                CreateAssignmentFact(
                    "inspector.intent.capability-filter",
                    "Intent Capability Filter",
                    "Use Intent to focus the graph on the capabilities the creator cares about; durable setup stays in gameplay assets, scene objects, and contracts.",
                    "Capability setup",
                    "Intent tab toggles -> reflected graph capability focus",
                    "Pyralis Authoring Window",
                    "Intent",
