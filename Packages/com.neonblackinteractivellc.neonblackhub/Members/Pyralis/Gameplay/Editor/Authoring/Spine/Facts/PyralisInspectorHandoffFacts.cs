        ...
        public static IReadOnlyList<PyralisAuthoringFact> GetAuthoringFacts()
        {
            return new[]
            {
                ...
                CreateAssignmentFact(
                    ...
                    "Assign the setup recipe that lists runtime patterns for the route.",
                    "Core setup chain",
                    "GameModeDefinition.setupProfile -> GameSetupProfile",
                    "GameModeDefinition",
                    "Setup Profile",
                    "runtime pattern selection becomes route-aware",
                    new[] { "setup.assign-setup-profile" }),

                CreateAssignmentFact(
                    "inspector.game-setup-profile.runtime-patterns",
                    "GameSetupProfile Runtime Patterns",
                    "Assign runtime pattern definitions that describe the supported route capabilities.",
                    "Capability setup",
                    "GameSetupProfile.runtimePatterns -> RuntimePatternDefinition[]",
                    "GameSetupProfile",
                    "Runtime Patterns",
