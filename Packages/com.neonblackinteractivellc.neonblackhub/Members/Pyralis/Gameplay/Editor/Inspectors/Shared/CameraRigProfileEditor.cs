...
namespace NeonBlack.Gameplay.Editor.Inspectors
{
    ...
    public class CameraRigProfileEditor : GameplayBaseEditor
    {
        ...
        protected override void DrawCustomInspector()
        {
            ...
            if (!profile.useCinemachine)
                EditorGUILayout.HelpBox("Gameplay camera setup expects Cinemachine-backed rigs by default. Disable this only when the scene owns camera composition manually.", MessageType.Info);
