...
{
    internal readonly struct RpgRuntimeServices
    {
        public RpgRuntimeServices(
    ...
    internal static class RpgServiceInstaller
    {
        public static RpgRuntimeServices Register(
