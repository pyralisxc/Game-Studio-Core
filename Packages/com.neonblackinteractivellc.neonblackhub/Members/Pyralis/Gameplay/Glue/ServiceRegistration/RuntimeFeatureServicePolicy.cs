...
{
    internal readonly struct RuntimeFeatureServicePolicy
    {
        public RuntimeFeatureServicePolicy(
        ...
        public RuntimeFeatureServicePolicy WithLoadedSceneEvidence(
            bool usesCombatServices,
            bool usesEnemyServices,
            bool usesRpgServices,
            bool usesGameFlowServices,
            ...
            bool usesFeedbackServices)
        {
            return new RuntimeFeatureServicePolicy(
                UsesCombatServices || usesCombatServices,
                UsesEnemyServices || usesEnemyServices,
                UsesRpgServices || usesRpgServices,
                UsesGameFlowServices || usesGameFlowServices,
        ...
        public static RuntimeFeatureServicePolicy Resolve(SessionDefinition sessionDefinition)
        {
        ...
        public static RuntimeFeatureServicePolicy ResolveWithLoadedSceneEvidence(SessionDefinition sessionDefinition)
        {
