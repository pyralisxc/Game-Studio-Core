...
- **Hygiene**: the developer audit console; shows graph integrity, blockers, recommended edits, proof enhancers, source origins, stable graph ids, proof reachability, and source/dependency pressure for the selected setup object and package.
