...
- `PyralisAuthoringRouteProof` remains route-proof fallback grammar, while `PyralisAuthoringOverviewModel`, graph projections, and tab renderers project resolved setup graph output.
