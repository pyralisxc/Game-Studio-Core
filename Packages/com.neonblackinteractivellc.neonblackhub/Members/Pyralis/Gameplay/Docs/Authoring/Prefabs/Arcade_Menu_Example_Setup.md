...
4. Add `HazardSpawner`.
5. Add `CollectibleSpawner2D` or a custom pickup spawner that implements the pickup spawn/burst contracts expected by your scene.
...
7. In `GameManager`, assign:
   ...
   - pickup spawner
   - `DifficultyManager`
   - `CinemachineCameraRigController` as Camera Rig Controller / Camera Bounds Source
