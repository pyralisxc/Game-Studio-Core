...
| `PyralisAuthoringCapabilityDescriptorRegistry` | reflected capability descriptors built from contracts and reflection only |
...
- Migration-only files should be archived with removal criteria or deleted once graph-backed parity is proven.
