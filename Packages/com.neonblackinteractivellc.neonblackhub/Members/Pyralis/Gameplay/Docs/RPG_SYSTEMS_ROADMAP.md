...
- `RpgHubProofRouteFactory` and `RpgHubProofRouteIds` provide a reusable proof route for dialogue, quest board, vendor, loadout, trainer, and portal interactions.
