...
2. `Docs/Setup/AUTHORING_MODEL.md`
3. `Docs/Setup/Prefabs/Bootstrap_Example_Setup.md`
4. `Docs/Setup/RUNTIME_PATTERN_COOKBOOK.md` when choosing or authoring setup patterns
5. `Docs/Setup/Prefabs/Pawn_Setup.md` only for pawn-backed games
6. feature-specific setup docs as needed
7. `Docs/Setup/MANUAL.md` when you want the book-style index
8. `Docs/Setup/Systems/Architecture_Overview.md` when changing architecture
