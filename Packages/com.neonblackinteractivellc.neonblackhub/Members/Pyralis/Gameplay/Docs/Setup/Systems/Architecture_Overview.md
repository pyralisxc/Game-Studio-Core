...
- treat Inspector guides as the live checklist, `Docs/Setup/START_HERE.md` as the first-scene beginner path, `Docs/Setup/MANUAL.md` as the setup index, and `Docs/Setup/CANONICAL_SETUP.md` as the technical contract
