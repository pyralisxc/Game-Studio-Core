...
namespace NeonBlack.Gameplay.Core.Contracts
{
    ...
    public sealed class PyralisRuntimeValidationIssue
    {
        ...
        public static PyralisRuntimeValidationIssue Recommended(
            string message,
            string fieldPath = null,
            string targetLabel = null,
            string nativeAction = null,
            ...
            string issueCode = null)
        {
            return new PyralisRuntimeValidationIssue(
                ...
                nativeAction,
                successCheck,
                PyralisRuntimeValidationSeverity.Recommended,
                issueCode);
        }

        public static PyralisRuntimeValidationIssue Optional(
            string message,
            string fieldPath = null,
            string targetLabel = null,
            string nativeAction = null,
            ...
            string issueCode = null)
        {
            return new PyralisRuntimeValidationIssue(
                ...
                nativeAction,
                successCheck,
                PyralisRuntimeValidationSeverity.Optional,
                issueCode);
        }
    }
