...
Do not put authoring metadata here. Authoring contract attributes, resolved authoring contracts, and authoring spine vocabulary live in `Core/AuthoringContracts`.
