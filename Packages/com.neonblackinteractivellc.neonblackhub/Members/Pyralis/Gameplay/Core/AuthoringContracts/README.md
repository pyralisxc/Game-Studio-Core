...
Keep this folder focused on player-safe contract flags, contract attributes, and resolved metadata records. Runtime service interfaces belong in `Core/RuntimeContracts`.
