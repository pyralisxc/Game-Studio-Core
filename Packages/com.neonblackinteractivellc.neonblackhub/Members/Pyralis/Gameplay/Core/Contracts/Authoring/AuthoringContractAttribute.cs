...
namespace NeonBlack.Gameplay.Core.Contracts
{
    ...
    /// <summary>
    /// Projection-facing role for a contract. This keeps Intent, Guide, Map,
    /// Hygiene, and Facts from inferring ownership from names or paths.
    /// </summary>
    public enum AuthoringContractSurface
    {
        Auto,
        GameplayIngredient,
        RouteEssential,
    ...
    {
        public const string IntentRouteEssential = "IntentRouteEssential";
        public const string CoreRouteAnchor = "CoreRouteAnchor";
        public const string ParticipantRouteSupport = "ParticipantRouteSupport";
...
/// Use this to match against the granular intent in the Authoring Window.
        ...
        /// <summary>
        /// Declares how this contract may surface in authoring projections.
        /// GameplayIngredient is the only value that can become an Intent toggle.
        /// </summary>
        public AuthoringContractSurface Surface { get; set; } = AuthoringContractSurface.Auto;
        ...
        /// Keep Proof as human developer guidance; use this only for machine-readable proof routing.
        /// </summary>
        public string ProofTargetId { get; set; }
