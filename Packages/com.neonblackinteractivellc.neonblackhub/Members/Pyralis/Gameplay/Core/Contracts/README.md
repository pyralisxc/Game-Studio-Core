...
- shared contracts that describe how gameplay components talk to each other
...
If a file only explains setup meaning for the Authoring Window, it belongs in authoring contracts or grammar instead of this runtime contracts folder.
