namespace NeonBlack.Gameplay.Core.Contracts
{
    ...
    /// <summary>
    /// Pure contract for gameplay time-scale management. Deprecates static TimeScaleService access.
    /// </summary>
    public interface ITimeScaleService : IHitPauseSink, IGameplayTimePolicy
    {
    }
