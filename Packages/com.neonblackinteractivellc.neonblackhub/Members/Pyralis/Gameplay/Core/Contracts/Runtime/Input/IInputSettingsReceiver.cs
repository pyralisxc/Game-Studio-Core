...
/// <summary>
/// Implemented by any system that receives input-related settings pushed from GameplaySettingsService.
/// Decouples GameplaySettingsService from concrete input handlers.
/// </summary>
public interface IInputSettingsReceiver
{
    /// <summary>
    /// Apply the latest input settings.
    /// Called automatically by GameplaySettingsService.Apply() and whenever an individual setting changes.
    /// </summary>
