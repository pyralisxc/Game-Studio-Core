...
Intent axioms live here as contract vocabulary so the Authoring Window can render them without owning setup routes. Editor grammar may supply generic wording, but it should not inject feature-specific setup requirements into contract-backed descriptors.
