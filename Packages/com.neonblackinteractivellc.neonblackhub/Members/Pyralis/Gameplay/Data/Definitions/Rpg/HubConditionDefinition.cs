...
{
    [Serializable]
    public struct HubConditionDefinition
    {
        ...
        public HubInteractionCondition CreateRuntimeCondition()
        {
            return new HubInteractionCondition(kind, TargetId, ComparisonValue, RequiredQuantity, expected);
        }
