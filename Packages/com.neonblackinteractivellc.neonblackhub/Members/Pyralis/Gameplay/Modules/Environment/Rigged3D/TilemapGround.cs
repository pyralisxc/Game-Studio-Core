...
namespace NeonBlack.Gameplay.Modules.Environment
{
/// <summary>
...
public class TilemapGround : MonoBehaviour
{
    ...
    public void BakeTilemapToGround()
    {
        ...
        {
            Debug.LogWarning($"[TilemapGround] Layer '{_groundLayerName}' does not exist. Keeping current GameObject layer.", this);
        }
