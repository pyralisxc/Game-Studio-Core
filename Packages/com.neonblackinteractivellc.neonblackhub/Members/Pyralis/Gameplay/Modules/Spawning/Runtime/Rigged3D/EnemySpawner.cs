...
public class EnemySpawner : MonoBehaviour, IEncounterSpawnSource
{
    ...
    private void SpawnOne()
    {
        ...
        IActorHealthState health = enemy.GetComponent<IActorHealthState>();
        if (health == null)
        {
            Debug.LogWarning($"[EnemySpawner] Spawned '{enemy.name}' has no IActorHealthState - alive count may drift.", this);
            return;
        }
    ...
    private void HandleTrackedEnemyDeath(IActorHealthState health)
    {
