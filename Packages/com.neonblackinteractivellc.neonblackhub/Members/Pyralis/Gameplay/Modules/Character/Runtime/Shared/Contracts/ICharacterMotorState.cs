...
namespace NeonBlack.Gameplay.Modules.Character
{
    ...
    [AuthoringContract(
        ...
        Proof = "Verify that the motor correctly reports IsGrounded when touching a ground collider.",
        NativeSetup = new[] { "Implement interface in a motor component" },
        ExpertAdvice = "Exposes motor snapshots. Other features (like Combat or UI) should query this for movement state instead of concrete motors to maintain architecture decoupling.",
