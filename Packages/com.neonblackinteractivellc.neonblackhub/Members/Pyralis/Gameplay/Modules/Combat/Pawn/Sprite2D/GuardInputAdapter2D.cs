...
namespace NeonBlack.Gameplay.Modules.Combat
{
    [AuthoringContract(
        ...
        CapabilityPath = "Combat/Actions/Guard Input Adapter 2D",
    ...
    public class GuardInputAdapter2D : MonoBehaviour, IActorGuardInputReceiver2D, IRuntimeValidationProvider
    {
        public IEnumerable<RuntimeValidationIssue> GetRuntimeValidationIssues()
        {
            if (GetComponent<IActorGuardController>() == null)
                yield return RuntimeValidationIssue.Required("No sibling IActorGuardController is available for guard input.");
        }
