...
namespace NeonBlack.Gameplay.Modules.Enemies
{
    public class PatrolState : IEnemyAIState
    {
        ...
        public void OnUpdate(EnemyAI ai, float deltaTime)
        {
            ...
            ai.MovementModule.MoveToward(target, ai.MoveSpeed * 0.6f, ai.StatusMoveSpeedMultiplier, deltaTime, ai.PresentationCamera, ai.VisualRoot, ai.SpriteDefaultFacesRight, ai.CombatTactics?.FacingMirrorTargets);
