...
public class PlayerRegistry : MonoBehaviour, IPlayerProvider
{
    ...
    public static Transform Player => ResolveFallbackPlayer() ?? _player;

    /// <summary>The current living participant/player's supported 2D motor, or null if none exists.</summary>
    public static Motor2D Motor2D => ResolveFallbackMotor2D() ?? _motor2D;
    ...
    // IPlayerProvider
    public UnityEngine.Transform GetPlayerTransform() => _player;
    public UnityEngine.GameObject GetPlayerGameObject() => _player != null ? _player.gameObject : null;
