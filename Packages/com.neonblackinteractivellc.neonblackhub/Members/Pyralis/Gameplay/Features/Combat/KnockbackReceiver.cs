...
///
/// Setup:
///   - This component requires a CharacterController on the same GameObject.
///   - Call ApplyKnockback(direction * force) from HitBox or any damage source.
///   - The character controller script must call Tick(deltaTime) each frame and
...
public class KnockbackReceiver : MonoBehaviour, IActorKnockbackController
{
    ...
    /// <summary>Instantly zeroes knockback velocity - call on death or teleport.</summary>
