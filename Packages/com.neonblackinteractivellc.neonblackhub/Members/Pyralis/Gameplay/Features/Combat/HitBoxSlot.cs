...
///
/// Setup:
///   1. Add child GameObjects to your character - one per zone (e.g. HitBox_Punch, HitBox_Kick).
///   2. Add a BoxCollider (Is Trigger = true) and a HitBox component to each child.
///   3. Set the child's Layer to HitBox.
///   4. In PawnCombatBehaviour -> Hit Box Zones, add a slot for each child and match the zone name.
